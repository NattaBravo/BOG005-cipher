...
## Proceso de desarrollo y objetivos de aprendizaje:

El proceso de desarrollo de esta herramienta fue organizado en 3 etapas:

ETAPA 1:
- Desarrollo de código HTML, estilos en CSS.
    [Trabajo con prototipo de alta fidelidad a través de FIGMA](https://www.figma.com/file/LIjRGNfF8MaWaju6fUZsYg/Untitled?node-id=0%3A1)
    [- Diseño de propuesta]
    [- Estilos CSS con selectores y manipulación de cajas](https://www.figma.com/proto/LIjRGNfF8MaWaju6fUZsYg/Untitled?node-id=0%3A3&scaling=min-zoom&page-id=0%3A1)
...
ETAPA 3:
- Desarrollo de soporte de manipulación de datos 
